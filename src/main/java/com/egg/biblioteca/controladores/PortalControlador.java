...
public class PortalControlador {
    ...
    public String registro(@RequestParam String nombre,
        ...
        try {
            ...
            modelo.put("exito", "usuario registrado perfectamente");
    ...
    public String login(@RequestParam(required = false) String error, ModelMap modelo) {
        if (error != null) {
            modelo.put("error", "usuario o clave invalido");
        }
        return "login.html";
    }
    ...
    public String actualizar(MultipartFile archivo, @PathVariable String id,
            @RequestParam String nombre, @RequestParam String email, @RequestParam String password, @RequestParam String password2, ModelMap modelo) {

        try {
            usuarioServicio.actualizar(archivo, id, nombre, email, password, password2);
            modelo.put("exito", "usuario actualizado correctamnete");
            return "index.html";
        } catch (MIException ex) {
